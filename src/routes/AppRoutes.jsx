...
import QuickCommerce from "../pages/QuickCommerce";
import ChannelDashboard from "../pages/ChannelPerformance";
import Channel from "../pages/Channel"; // Add this import
...
const AppRoutes = () => {
  return (
    <Routes>
      ...
      />
      <Route
        path="/quick-commerce/channel-performance"
        element={
          isAuthenticated() ? <Channel /> : <Navigate to="/" replace />
        }
      />
      <Route
        path="/quick-commerce/channel/:channelName"
        element={
          isAuthenticated() ? <ChannelDashboard /> : <Navigate to="/" replace />
        }
      />
      <Route
        path="/orders"
